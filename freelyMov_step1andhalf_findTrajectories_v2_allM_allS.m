...
%mouse = 'A2a1';
%session = 'S6';
data_path = strcat(raw_folder,filesep,group,filesep,setup);
...
for m = 8:10% :num_animals
    ...
    for s=1:num_sessions
        ...
        all_sess_path_mat=strcat(mat_folder,filesep,group,filesep,setup,filesep,char(mice(m,1)));
